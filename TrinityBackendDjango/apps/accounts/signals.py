...
# Disabled: User creation logic moved to UserViewSet.create()
# This signal only worked when users were created in tenant schema,
# but we now create users in public schema and handle UserTenant/UserRole in ViewSet
