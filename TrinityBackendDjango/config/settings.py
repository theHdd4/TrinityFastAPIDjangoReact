...
_default_csrf = (
    f"http://192.168.1.98:8080,http://10.2.1.65:8080,https://trinity.quantmatrixai.com"
)
...
# ------------------------------------------------------------------
_default_cors = (
    "http://192.168.1.98:8080,http://10.2.1.65:8080,https://trinity.quantmatrixai.com",
)
CORS_ALLOWED_ORIGINS = [
    o.strip()
