  ...
  return (
    <div className={`absolute inset-0 flex items-center justify-center bg-white ${className}`}>
      ...
      <div className="relative z-10 text-center px-6">
        <h3 className="text-2xl font-light text-black mb-2 matrix-loader-text">Loading</h3>
        <div className="flex items-center justify-center space-x-1 text-black matrix-loader-text">
          <span>{status}</span>
      ...
      <style>{`
        ...
        .matrix-loader-text,
        .matrix-loader-text * {
          text-shadow: -0.5px -0.5px 0 rgba(255, 255, 255, 0.85),
