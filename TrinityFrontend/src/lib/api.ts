...
export const EXHIBITION_EXPORT_API =
  normalizeUrl(import.meta.env.VITE_EXHIBITION_EXPORT_API) ||
  `${backendOrigin.replace(new RegExp(`:${djangoPort}$`), `:${fastapiPort}`)}/api/export`;
