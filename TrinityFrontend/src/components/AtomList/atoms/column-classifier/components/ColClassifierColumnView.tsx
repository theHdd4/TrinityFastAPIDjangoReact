          ...
          <div className="min-w-max">
            <div className="grid grid-rows-4 gap-0">
              <div className="flex bg-white border-b border-gray-200">
                <div className="w-40 px-4 py-0.5 font-bold text-black bg-gray-100 border-r border-gray-300">
                  Columns
                </div>
                {displayed.map((col, index) => (
                  <div
                    key={index}
                    className="w-32 px-4 py-0.5 text-sm font-semibold text-black border-r border-gray-200 text-center"
                  >
                    {col.column}
                  </div>
                ))}
              ...
              <div className="flex bg-white border-b border-gray-200">
                ...
                {displayed.map((col, index) => (
                  <div
                    key={index}
                    className="w-32 px-4 py-0.5 text-sm border-r border-gray-200 text-center"
                  >
                    <Badge
                      variant="outline"
              ...
              <div className="flex bg-gray-50 border-b border-gray-200">
                ...
                {displayed.map((col, index) => (
                  <div
                    key={index}
                    className="w-32 px-4 py-0.5 text-sm text-black border-r border-gray-200 text-center font-medium"
                  >
                    {col.unique_count}
                  </div>
                ))}
