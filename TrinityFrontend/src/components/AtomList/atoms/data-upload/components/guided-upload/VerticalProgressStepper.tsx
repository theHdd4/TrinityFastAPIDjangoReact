...
const STAGES: Array<{ id: UploadStage; label: string; shortLabel: string; category?: string }> = [
  { id: 'U0', label: 'Upload Dataset', shortLabel: 'Upload', category: 'SETUP' },
  { id: 'U1', label: 'Structural Scan', shortLabel: 'Scan', category: 'CONFIGURATION' },
  { id: 'U2', label: 'Confirm Headers', shortLabel: 'Headers', category: 'CONFIGURATION' },
  { id: 'U3', label: 'Column Names', shortLabel: 'Columns', category: 'CONFIGURATION' },
  { id: 'U4', label: 'Data Types', shortLabel: 'Types', category: 'CONFIGURATION' },
  { id: 'U5', label: 'Missing Values', shortLabel: 'Missing', category: 'VALIDATION' },
  { id: 'U6', label: 'Final Preview', shortLabel: 'Preview', category: 'VALIDATION' },
  { id: 'U7', label: 'Complete', shortLabel: 'Complete', category: 'EXECUTION' },
];
