...
import { BarChart3, TrendingUp, Maximize2, X, ArrowUp, ArrowDown, Filter as FilterIcon } from "lucide-react";
...
const FeatureOverviewCanvas: React.FC<FeatureOverviewCanvasProps> = ({
  ...
  // Legacy displayedSummary removed - now using DataSummaryView

  // Legacy getUniqueColumnValues removed - now using DataSummaryView

  // Legacy handleSort removed - now using DataSummaryView
  ...
  // Legacy filtering/sorting functions removed - now using DataSummaryView
  ...
  return (
    <div className="w-full h-full p-6 pb-[50px] bg-gradient-to-br from-slate-50 to-blue-50 overflow-y-auto">
      ...
      {settings.dataSource && settings.showDataSummary && (
        <div className="mb-8 border-b border-slate-200 px-5 py-4">
          <DataSummaryView
