...
import { Database, ChevronRight, ChevronDown, ChevronUp, Trash2, Pencil, Loader2, ChevronLeft, Download, Upload, Layers, SlidersHorizontal, RefreshCw } from 'lucide-react';
...
const SavedDataFramesPanel: React.FC<Props> = ({ isOpen, onToggle, collapseDirection = 'right' }) => {
  ...
  const handleContextMenuAction = (action: 'edit' | 'delete' | 'classify' | 'process' | 'downloadCSV' | 'downloadExcel' | 'changeSheet') => {
