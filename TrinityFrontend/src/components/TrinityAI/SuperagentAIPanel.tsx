...
import { Send, X, Bot, User, Sparkles, RotateCcw, Clock, Settings, Paperclip, Mic, Plus, Trash2, MessageCircle, Minimize2, Maximize2, Minus, Square, File } from 'lucide-react';
                ...
                {workflowProgress && (
                  <div className="mt-2">
                    <p className="text-gray-600 font-inter text-xs">
                      Progress: {workflowProgress.completed_steps || 0}/{workflowProgress.total_steps || 0} steps
                    </p>
                  </div>
                )}
              </div>
