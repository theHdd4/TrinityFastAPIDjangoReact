...
export const TextBoxToolbar: React.FC<TextBoxToolbarProps> = ({
  ...
  return (
    <div
      className="relative flex w-full max-w-full items-center justify-center gap-2 overflow-x-auto whitespace-nowrap rounded-full border border-border/70 bg-background/95 px-3 py-2.5 text-sm shadow-[0_24px_48px_-22px_rgba(124,58,237,0.45)] backdrop-blur-lg"
      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button
            ...
            size="sm"
            type="button"
            className="relative h-8 min-w-[120px] justify-between rounded-full border border-border/50 px-3 text-[11px] font-medium text-foreground hover:bg-muted/40"
