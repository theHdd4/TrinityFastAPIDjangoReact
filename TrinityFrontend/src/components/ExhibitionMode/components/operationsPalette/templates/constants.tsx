...
const buildSlideDefinition = (
  ...
  spec.placeholders.forEach((placeholder, placeholderIndex) => {
    ...
    const isVisualPlaceholder = placeholder.type === 'chart' || placeholder.type === 'image';

    if (isVisualPlaceholder) {
      const caption = placeholder.description ?? placeholder.label;
      placeholderTextBoxes.push({
        text: caption,
    ...
    } else if (placeholder.type === 'metric') {
