...
import { DEFAULT_CHART_CONFIG, DEFAULT_CHART_DATA, DEFAULT_CHART_HEIGHT, DEFAULT_CHART_WIDTH } from './constants';
...
export const createChartSlideObject = (
  ...
  const resolvedConfig: ChartConfig = { ...DEFAULT_CHART_CONFIG, ...(options.config ?? {}) };
