...
origins = os.getenv(
    ...
    "http://10.184.0.220:8080,http://10.2.1.173:8080,http://127.0.0.1:8080,http://10.2.1.242:8080,http://10.2.1.65:8080,http://10.142.213.220,https://trinity.quantmatrixai.com",
)
